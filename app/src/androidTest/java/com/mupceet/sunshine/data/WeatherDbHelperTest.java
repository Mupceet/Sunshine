...
import static com.mupceet.sunshine.data.TestUtilities.getConstantNameByStringValue;
import static com.mupceet.sunshine.data.TestUtilities.getStaticIntegerField;
import static com.mupceet.sunshine.data.TestUtilities.getStaticStringField;
import static com.mupceet.sunshine.data.TestUtilities.studentReadableClassNotFound;
import static com.mupceet.sunshine.data.TestUtilities.studentReadableNoSuchField;
...
public class WeatherDbHelperTest {
     ...
     */
    private static final String packageName = "com.mupceet.sunshine";
    ...
    public void before() {
        try {
            ...
            if (weatherDbHelperSuperclass == null || weatherDbHelperSuperclass.equals(Object.class)) {
                ...
                Assert.assertTrue(doesNotExtendOpenHelper,
            ...
            dbHelper = (SQLiteOpenHelper) weatherDbHelperCtor.newInstance(mContext);

            mContext.deleteDatabase(REFLECTED_DATABASE_NAME);
...
//    }
    ...
    public void testDatabaseVersion() {
        ...
        String databaseVersionShouldBe = "Database version should be "
                + expectedDatabaseVersion + " but isn't."
                + "\n Database version: ";

        Assert.assertEquals(databaseVersionShouldBe,
    ...
    public void testDuplicateDateInsertBehaviorShouldReplace() {
        ...
        Assert.assertTrue(recordWithNewIdNotFound,
        ...
        for (String columnName : weatherTableColumnNames) {
            ...
            String nullRowInsertShouldFail =
                    "Insert should have failed due to a null value for column: '" + columnName + "'"
                            ...
                            + "\n Row ID: ";
            Assert.assertEquals(nullRowInsertShouldFail,
                    -1,
                    shouldFailRowId);
    ...
    public void testIntegerAutoincrement() {
        ...
        Assert.assertNotSame(sequentialInsertsDoNotAutoIncrementId,
    ...
    public void testOnUpgradeBehavesCorrectly() {
        ...
        Assert.assertEquals(shouldHaveSingleTable,
                expectedTableCount,
        ...
        String weatherTableShouldBeEmpty =
                "Weather table should be empty after upgrade, but wasn't."
                        + "\nNumber of records: ";
        Assert.assertEquals(weatherTableShouldBeEmpty,
     ...
     * <p>
     * {@link com.mupceet.sunshine.data.WeatherContract.WeatherEntry#TABLE_NAME}.
     * <p>
...
//        tableNameHashSet.add(MyOtherCoolTableNameThatContainsOtherCoolData);
        ...
        Assert.assertTrue("Error: Your database was created without the expected tables.",
    ...
    public void testInsertSingleRecordIntoWeatherTable() {
        ...
        Assert.assertNotSame(insertFailed,

...
public class WeatherProviderTest {
    ...
    public void testProviderRegistry() {
        ...
        try {
            ...
            Assert.assertEquals(incorrectAuthority,
                    actualAuthority,
                    expectedAuthority);
    ...
    public void testBasicWeatherQuery() {
        ...
        Assert.assertTrue(insertFailed, weatherRowId != -1);
    ...
    public void testDeleteAllRecordsFromProvider() {
        ...
        Assert.assertNotNull(cursorWasNull, shouldBeEmptyCursor);
        ...
        Assert.assertEquals(allRecordsWereNotDeleted,
                0,
